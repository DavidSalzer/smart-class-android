smartClassApp.controller('textParagraph4Question', ['$scope','$stateParams','slideData', function ($scope,$stateParams,slideData) {
//$scope.data = {
//    user: "Pnina Lorman",
//    title: "Tfila",
...
//    }	
    ...
    $scope.data.html+='<a class="translate" style="display:block" data-ng-click="translate()">Translate</a>'//reut add because the design
