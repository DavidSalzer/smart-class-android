smartClassApp.controller('Paragraph3Question', ['$scope','$timeout', function ($scope,$timeout) {
$scope.data = {
    user: "Pnina Lorman",
    title: "Tfila",
 ...
 //start animation after 1 S- scrooling
    $timeout(function(){
    	angular.element(document.getElementsByClassName('mekorot_1_body')).addClass('animet');
    },1000);
